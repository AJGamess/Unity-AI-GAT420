...
public class NavPath : MonoBehaviour
{
    ...
    public void GeneratePath(Vector3 startPostion, Vector3 endPosition)
    {
        // Find the closest navigation nodes to the agent and the destination position
        NavNode startNode = NavNode.GetNearestNavNode(startPostion);
